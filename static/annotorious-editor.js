...
function recorder() {
        ...
        var iframe = document.createElement('iframe');
        iframe.setAttribute('id', 'recorderUI');
        iframe.src = 'http://localhost:9050/recorder/';
...
function hideRecorder() {
    var container = document.getElementById('toolbars');
    container.parentNode.removeChild(document.getElementById('recorderUI'));
}
